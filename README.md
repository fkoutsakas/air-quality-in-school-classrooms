...
2. διαδικτυακή πλατφόρμα ανοιχτής πρόσβασης για την παρουσίαση των καταγεγραμμένων τιμών ποιότητας αέρα σε πραγματικό χρόνο μέσα και έξω από την αίθουσα και παρακολούθηση του επιπέδου θορύβου στην αίθουσα.
