...
- 1 χ Raspberry Pi  με αισθητήρα  παρακολούθησης της ποιότητας αέρα στο εσωτερικό της αίθουσας. (μετακίνηση σε διαφορετικά σημεία στο εσωτερικό της αίθουσας)
...
- 1 χ Raspberry Pi  με Sense ΗΑΤ για παρακολούθηση των συνθηκών, μέτρηση θερμοκρασίας, υγρασίας, ατμοσφαιρικής πίεσης (τοποθέτηση σε εξωτερικό χώρο)
- 1 χ Raspberry Pi  με Sound Sensor για παρακολούθηση του επιπέδου θορύβου που εισάγει στην αίθουσα ο εξαεριστήρας (μετρήσεις σε διάφορα σημεία της αίθουσας)
